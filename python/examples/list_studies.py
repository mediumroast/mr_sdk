...
def parse_cli_args(program_name='list_interactions', desc='A mediumroast.io example utility that lists interactions using mr_api.'):
    ...
    parser.add_argument ('--get_iterations', help="Get all iterations or by status", type=str, dest='get_iterations')
    parser.add_argument ('--get_questions', help="Get all questions", type=str, dest='get_questions')
